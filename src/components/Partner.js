...
function Partner() {
  return (
    <div className="flex flex-col items-center justify-center gap-6 bg-lightGray px-3 py-6 lg:px-36 lg:py-16 lg:flex-row lg:justify-between" id="partnerships">
        <div className="text-primary text-center lg:text-left">
            <p className="font-bold text-2xl lg:text-7xl">25+</p>
            <h3 className="text-sm lg:text-xl mt-1">PARTNERED BRANDS</h3>
        </div>
