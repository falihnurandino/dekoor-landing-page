...
function Advantage() {
  return (
    <div className="flex flex-col gap-6 text-caramel bg-primary px-3 py-6 lg:px-36 lg:py-12 lg:gap-10" id="about-us">
        <h3 className="text-center text-xl lg:text-left">WHY CHOOSE US?</h3>
