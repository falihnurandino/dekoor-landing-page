...
function App() {
  return (
    <div className="app">
      <header className=" py-3 px-4 bg-white shadow sticky top-0 z-50 lg:py-6 lg:px-14">
        <Navigation />
      </header>
      <main>
        <Hero />
      ...
      <footer className="grid gap-10 py-6 px-4 lg:px-16 lg:py-14 text-center lg:text-left lg:grid-cols-2">
        <section className="flex flex-col items-center gap-6 lg:items-start">
          ...
          <p className="text-lightBlue text-sm hidden lg:block">©Copyright 2023 Dekoor</p>
        </section>
